      ...
      <section className="py-20 bg-gradient-to-br from-primary-50 to-muted dark:from-primary-900/20 dark:to-muted pt-32">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            >
              <h1 className="text-4xl sm:text-5xl font-bold mb-6 text-foreground">About GreenThumb</h1>
              <p className="text-lg text-muted-foreground mb-6">
                We're passionate about bringing the beauty and benefits of plants into every space. Founded in 2018, 
                GreenThumb has grown from a small local nursery to a premier destination for plant lovers and interior designers alike.
              </p>
              <p className="text-lg text-muted-foreground mb-8">
                Our team of plant experts, horticulturists, and designers work together to provide not just beautiful plants, 
                but complete green living solutions that enhance your wellbeing and transform your environment.
              </p>
      ...
      <section className="py-16 bg-card">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <motion.div 
            ...
            viewport={{ once: true }}
          >
            <h2 className="text-3xl sm:text-4xl font-bold mb-4 text-foreground">Meet Our Team</h2>
            <p className="text-lg text-muted-foreground">Plant experts dedicated to helping you grow</p>
          </motion.div>
      ...
      <section className="py-16 bg-muted/50">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <motion.div 
            ...
            viewport={{ once: true }}
          >
            <h2 className="text-3xl sm:text-4xl font-bold mb-4 text-foreground">Our Mission</h2>
            <p className="text-lg text-muted-foreground max-w-3xl mx-auto">
              To make plant ownership accessible, enjoyable, and beneficial for everyone by providing 
              high-quality plants, expert guidance, and ongoing support.
            </p>
          </motion.div>

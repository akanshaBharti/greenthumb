        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
          ...
          >
            ...
            <p className="text-lg sm:text-xl mb-8 text-muted-foreground max-w-2xl mx-auto">
              Discover our curated collection of indoor plants, expert arrangements, and professional plant care services to bring nature into your home and office.
            </p>
            <motion.div 
      ...
      <section className="py-16 bg-card">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <motion.div 
            ...
            viewport={{ once: true }}
          >
            <h2 className="text-3xl sm:text-4xl font-bold mb-4 text-foreground">Featured Plants</h2>
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
              Handpicked selection of our most popular and beautiful indoor plants
            </p>
          </motion.div>
              ...
              >
                <Card className="overflow-hidden shadow-lg hover:shadow-xl transition-all duration-300">
                  ...
                  <CardContent className="p-6">
                    <h3 className="text-xl font-semibold mb-2 text-foreground" data-testid={`text-plant-name-${plant.id}`}>
                      {plant.name}
                    </h3>
                    <p className="text-muted-foreground mb-4" data-testid={`text-plant-description-${plant.id}`}>
                      {plant.description}
                    </p>
                    <div className="flex justify-between items-center">
                      <span className="text-2xl font-bold text-primary" data-testid={`text-plant-price-${plant.id}`}>
                        ${plant.price}
                      </span>
                      <Button 
                        size="sm"
      ...
      <section className="py-16 bg-muted/50">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-lg text-muted-foreground">Expert plant care and design services for every space</p>
          </motion.div>

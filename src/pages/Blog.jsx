    ...
    <>
      ...
      <section className="py-20 bg-gradient-to-br from-muted to-primary-50 dark:from-muted dark:to-primary-900/20 pt-32">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            <h1 className="text-4xl sm:text-5xl font-bold mb-6 text-foreground">Plant Care Blog</h1>
            <p className="text-lg text-muted-foreground max-w-3xl mx-auto">
              Expert tips, guides, and insights to help you become a better plant parent. 
              Learn from our team of horticulturists and plant enthusiasts.
            </p>
          </motion.div>
        </div>
      </section>
      ...
      <section className="py-16 bg-muted/50">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col md:flex-row justify-between items-center mb-12">
            <h2 className="text-3xl font-bold text-foreground mb-4 md:mb-0">Latest Articles</h2>
              ...
              >
                <Card className="overflow-hidden shadow-lg hover:shadow-xl transition-all duration-300 h-full">
                  ...
                  <CardContent className="p-6 flex flex-col h-full">
                    ...
                    <h3 className="text-xl font-semibold mb-3 text-foreground leading-tight flex-grow" data-testid={`text-title-${post.id}`}>
                      {post.title}
                    </h3>
                    <p className="text-muted-foreground mb-4 flex-grow" data-testid={`text-description-${post.id}`}>
                      {post.description}
                    </p>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            ...
            <p className="text-lg text-primary-foreground/80 mb-8">
              Get the latest plant care tips, new articles, and exclusive content delivered to your inbox weekly.
            </p>
            <form 
